...
import {WorkOnMistakes} from "../../training/components/WorkOnMistakes";
        ...
        <Suspense fallback={<Spinner/>}>
            <div className={styles.container}>
                ...
                <div className={styles.componentRow}>
                    ...
                    <Button variant={"faded"}
                            startContent={<img style={{width: "16px", height: "16px"}} src={SettingsSVG}
                                               alt={"Иконка"}/>}
                    >
                        Technical
                    </Button>
                ...
                <div className={styles.componentRow}>
                    <div style={{height: "300px", width: "500px"}}>
                        <ScrollBox>
                            ...
                            Mauris <br/>
                            placerat diam at urna sollicitudin lobortis. Vestibulum at ipsum non diam elementum
                            elementum
                            et <br/>
                            ...
                            sapien <br/>
                            quis, venenatis velit. Nulla molestie ac diam vitae pulvinar. Phasellus sit amet mi arcu.
                            Nam
                            ut <br/>
                            ante dapibus, ornare urna a, pharetra nulla. Interdum et malesuada fames ac ante ipsum
                            primis in<br/>
                            faucibus.
                        </ScrollBox>
                    </div>
                ...
                <TaskContinue next={() => console.log(123213)} isRightAnswer={true} rightAnswer={"awdawd"}/>
                <TaskContinue next={() => console.log(123213)} isRightAnswer={false} rightAnswer={"awdawd"}/>

                <h2 className={styles.componentTitle}>Прогресс уровня</h2>
                <ProgressBar currentStep={progressBar} stepCount={4}/>
                <div className={styles.componentRow}>
                    <Button startContent={
